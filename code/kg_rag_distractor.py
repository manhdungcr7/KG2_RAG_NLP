...
def init_model(args):
    # Ép dùng bản 1B cho nhẹ, khóa VRAM bằng num_ctx và tăng thời gian chờ lên 600s
    Settings.llm = Ollama(model='llama3.2:1b', request_timeout=600.0, additional_kwargs={"num_ctx": 4096})
    
    # Model nhúng nomic-embed-text đã được truyền vào từ args
...
if __name__=='__main__':
    ...
    parser.add_argument('--model_name',type=str,default='llama3.2',help='Ollama model name')
    parser.add_argument('--reranker',type=str,default='BAAI/bge-reranker-base',help='Path or model id of the reranker model')
